...
<div id="content"><jsp:include page="/header.jsp" flush="true" /> <jsp:include page="/menu.jsp" flush="true"><jsp:param name="caller" value="research" /></jsp:include><div id="centerCol">
   ...
   <table>
      <tr><td>URI</td><td><a href="<vivo:MedicalResidencySubjectURI/>"><vivo:MedicalResidencySubjectURI /></a></td></tr>
      <tr><td>Label</td><td><vivo:MedicalResidencyLabel /></td></tr>
   </table>
   ...
   <table>
      <vivo:foreachMedicalResidencyMajorFieldIterator>
         <tr><td>majorField</td><td><vivo:MedicalResidencyMajorField /></td></tr>
      </vivo:foreachMedicalResidencyMajorFieldIterator>
      <vivo:foreachMedicalResidencyDepartmentOrSchoolIterator>
         <tr><td>departmentOrSchool</td><td><vivo:MedicalResidencyDepartmentOrSchool /></td></tr>
      </vivo:foreachMedicalResidencyDepartmentOrSchoolIterator>
   </table>
