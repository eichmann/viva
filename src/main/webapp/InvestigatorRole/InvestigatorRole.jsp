...
<div id="content"><jsp:include page="/header.jsp" flush="true" /> <jsp:include page="/menu.jsp" flush="true"><jsp:param name="caller" value="research" /></jsp:include><div id="centerCol">
   <p><a href="altInvestigatorRole.jsp?uri=${param.uri}">alternate view</a></p>
   <p><a href="../utility/sparqlDump.jsp?type=InvestigatorRole&uri=${param.uri}">RDF dump</a></p>
   <viva:InvestigatorRole subjectURI="${param.uri}">

   <h3>Default Properties</h3>
   <table>
      <tr><td>URI</td><td><a href="<viva:InvestigatorRoleSubjectURI/>"><viva:InvestigatorRoleSubjectURI /></a></td></tr>
      <tr><td>Label</td><td><viva:InvestigatorRoleLabel /></td></tr>
   </table>
