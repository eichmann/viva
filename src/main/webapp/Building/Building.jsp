...
<title>Building - http://vivoweb.org/ontology/core#Building</title>
<style type="text/css" media="all">    @import "/viva/resources/style.css";</style></head>
<body>
<div id="content"><jsp:include page="/header.jsp" flush="true" /> <jsp:include page="/menu.jsp" flush="true"><jsp:param name="caller" value="research" /></jsp:include><div id="centerCol">
   <p><a href="altBuilding.jsp?uri=${param.uri}">alternate view</a></p>
   <p><a href="../utility/sparqlDump.jsp?type=Building&uri=${param.uri}">RDF dump</a></p>
   <viva:Building subjectURI="${param.uri}">

   <h3>Default Properties</h3>
   <table>
      <tr><td>URI</td><td><a href="<viva:BuildingSubjectURI/>"><viva:BuildingSubjectURI /></a></td></tr>
      <tr><td>Label</td><td><viva:BuildingLabel /></td></tr>
   </table>
