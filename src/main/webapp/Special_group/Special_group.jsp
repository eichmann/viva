   ...
   <table>
      <viva:foreachSpecial_groupIsSuccessorOfIterator>
         <tr><td>isSuccessorOf</td><td>
            <c:set var="localType"><viva:Special_groupIsSuccessorOfType/></c:set>
            <c:choose>
            <c:when test="${ localType eq 'null'}">
                  <a href="<viva:Special_groupIsSuccessorOf/>"><viva:Special_groupIsSuccessorOf/></a>
            </c:when>
            <c:otherwise>
                  <a href="../<viva:Special_groupIsSuccessorOfType/>/<viva:Special_groupIsSuccessorOfType/>.jsp?uri=<viva:Special_groupIsSuccessorOf/>"><viva:Special_groupIsSuccessorOf /></a>
            </c:otherwise>
            </c:choose>
         </td></tr>
      </viva:foreachSpecial_groupIsSuccessorOfIterator>
      <viva:foreachSpecial_groupIsPredecessorOfIterator>
         <tr><td>isPredecessorOf</td><td>
            <c:set var="localType"><viva:Special_groupIsPredecessorOfType/></c:set>
            <c:choose>
            <c:when test="${ localType eq 'null'}">
                  <a href="<viva:Special_groupIsPredecessorOf/>"><viva:Special_groupIsPredecessorOf/></a>
            </c:when>
            <c:otherwise>
                  <a href="../<viva:Special_groupIsPredecessorOfType/>/<viva:Special_groupIsPredecessorOfType/>.jsp?uri=<viva:Special_groupIsPredecessorOf/>"><viva:Special_groupIsPredecessorOf /></a>
            </c:otherwise>
            </c:choose>
         </td></tr>
      </viva:foreachSpecial_groupIsPredecessorOfIterator>
      <viva:foreachSpecial_groupHasMemberIterator>
         <tr><td>hasMember</td><td>
            <c:set var="localType"><viva:Special_groupHasMemberType/></c:set>
            <c:choose>
            <c:when test="${ localType eq 'null'}">
                  <a href="<viva:Special_groupHasMember/>"><viva:Special_groupHasMember/></a>
            </c:when>
            <c:otherwise>
                  <a href="../<viva:Special_groupHasMemberType/>/<viva:Special_groupHasMemberType/>.jsp?uri=<viva:Special_groupHasMember/>"><viva:Special_groupHasMember /></a>
            </c:otherwise>
            </c:choose>
         </td></tr>
      </viva:foreachSpecial_groupHasMemberIterator>
