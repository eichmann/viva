...
<div id="content"><jsp:include page="/header.jsp" flush="true" /> <jsp:include page="/menu.jsp" flush="true"><jsp:param name="caller" value="research" /></jsp:include><div id="centerCol">
   ...
   <p><a href="../utility/sparqlDump.jsp?type=ClinicalRole&uri=${param.uri}">RDF dump</a></p>
   <viva:ClinicalRole subjectURI="${param.uri}">

   <h3>Default Properties</h3>
   <table>
      <tr><td>URI</td><td><a href="<viva:ClinicalRoleSubjectURI/>"><viva:ClinicalRoleSubjectURI /></a></td></tr>
      <tr><td>Label</td><td><viva:ClinicalRoleLabel /></td></tr>
   </table>
