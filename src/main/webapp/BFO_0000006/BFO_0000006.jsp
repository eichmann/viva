   ...
   <table>
      <viva:foreachBFO_0000006RO_0001015Iterator>
         <tr><td>RO_0001015</td><td>
            <c:set var="localType"><viva:BFO_0000006RO_0001015Type/></c:set>
            <c:choose>
            <c:when test="${ localType eq 'null'}">
                  <a href="<viva:BFO_0000006RO_0001015/>"><viva:BFO_0000006RO_0001015/></a>
            </c:when>
            <c:otherwise>
                  <a href="../<viva:BFO_0000006RO_0001015Type/>/<viva:BFO_0000006RO_0001015Type/>.jsp?uri=<viva:BFO_0000006RO_0001015/>"><viva:BFO_0000006RO_0001015 /></a>
            </c:otherwise>
            </c:choose>
         </td></tr>
      </viva:foreachBFO_0000006RO_0001015Iterator>
      <viva:foreachBFO_0000006BFO_0000051Iterator>
         <tr><td>BFO_0000051</td><td>
            <c:set var="localType"><viva:BFO_0000006BFO_0000051Type/></c:set>
            <c:choose>
            <c:when test="${ localType eq 'null'}">
                  <a href="<viva:BFO_0000006BFO_0000051/>"><viva:BFO_0000006BFO_0000051/></a>
            </c:when>
            <c:otherwise>
                  <a href="../<viva:BFO_0000006BFO_0000051Type/>/<viva:BFO_0000006BFO_0000051Type/>.jsp?uri=<viva:BFO_0000006BFO_0000051/>"><viva:BFO_0000006BFO_0000051 /></a>
            </c:otherwise>
            </c:choose>
         </td></tr>
      </viva:foreachBFO_0000006BFO_0000051Iterator>
      <viva:foreachBFO_0000006BFO_0000050Iterator>
         <tr><td>BFO_0000050</td><td>
            <c:set var="localType"><viva:BFO_0000006BFO_0000050Type/></c:set>
            <c:choose>
            <c:when test="${ localType eq 'null'}">
                  <a href="<viva:BFO_0000006BFO_0000050/>"><viva:BFO_0000006BFO_0000050/></a>
            </c:when>
            <c:otherwise>
                  <a href="../<viva:BFO_0000006BFO_0000050Type/>/<viva:BFO_0000006BFO_0000050Type/>.jsp?uri=<viva:BFO_0000006BFO_0000050/>"><viva:BFO_0000006BFO_0000050 /></a>
            </c:otherwise>
            </c:choose>
         </td></tr>
      </viva:foreachBFO_0000006BFO_0000050Iterator>
