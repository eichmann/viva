...
<div id="content"><jsp:include page="/header.jsp" flush="true" /> <jsp:include page="/menu.jsp" flush="true"><jsp:param name="caller" value="research" /></jsp:include><div id="centerCol">
   ...
   <table>
      ...
      <viva:foreachdisputedDifferentFromIterator>
         <tr><td>differentFrom</td><td><viva:disputedDifferentFrom /></td></tr>
      </viva:foreachdisputedDifferentFromIterator>
      ...
      <viva:foreachdisputedGeographicFocusOfIterator>
         <tr><td>geographicFocusOf</td><td><viva:disputedGeographicFocusOf /></td></tr>
      </viva:foreachdisputedGeographicFocusOfIterator>
   </table>
