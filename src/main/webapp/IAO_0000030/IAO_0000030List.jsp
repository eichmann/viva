...
<table>
	<tr>
		<td>
			<c:if test="${limit > 0 && offset > 0}"><a href="IAO_0000030List.jsp?limit=${limit}&offset=${offset - limit}">&lt;</a></c:if>
		</td>
		<td>
			<c:if test="${limit > 0}"><a href="IAO_0000030List.jsp?limit=${limit}&offset=${offset + limit}">&gt;</a></c:if>
		</td>
	</tr>
</table>

<ul>
<viva:foreachIAO_0000030 limitCriteria="${limit}" offsetCriteria="${offset}" >
   <viva:IAO_0000030>
