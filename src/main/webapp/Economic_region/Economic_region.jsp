   ...
   <table>
      <viva:foreachEconomic_regionIsSuccessorOfIterator>
         <tr><td>isSuccessorOf</td><td>
            <c:set var="localType"><viva:Economic_regionIsSuccessorOfType/></c:set>
            <c:choose>
            <c:when test="${ localType eq 'null'}">
                  <a href="<viva:Economic_regionIsSuccessorOf/>"><viva:Economic_regionIsSuccessorOf/></a>
            </c:when>
            <c:otherwise>
                  <a href="../<viva:Economic_regionIsSuccessorOfType/>/<viva:Economic_regionIsSuccessorOfType/>.jsp?uri=<viva:Economic_regionIsSuccessorOf/>"><viva:Economic_regionIsSuccessorOf /></a>
            </c:otherwise>
            </c:choose>
         </td></tr>
      </viva:foreachEconomic_regionIsSuccessorOfIterator>
      <viva:foreachEconomic_regionIsPredecessorOfIterator>
         <tr><td>isPredecessorOf</td><td>
            <c:set var="localType"><viva:Economic_regionIsPredecessorOfType/></c:set>
            <c:choose>
            <c:when test="${ localType eq 'null'}">
                  <a href="<viva:Economic_regionIsPredecessorOf/>"><viva:Economic_regionIsPredecessorOf/></a>
            </c:when>
            <c:otherwise>
                  <a href="../<viva:Economic_regionIsPredecessorOfType/>/<viva:Economic_regionIsPredecessorOfType/>.jsp?uri=<viva:Economic_regionIsPredecessorOf/>"><viva:Economic_regionIsPredecessorOf /></a>
            </c:otherwise>
            </c:choose>
         </td></tr>
      </viva:foreachEconomic_regionIsPredecessorOfIterator>
      <viva:foreachEconomic_regionHasMemberIterator>
         <tr><td>hasMember</td><td>
            <c:set var="localType"><viva:Economic_regionHasMemberType/></c:set>
            <c:choose>
            <c:when test="${ localType eq 'null'}">
                  <a href="<viva:Economic_regionHasMember/>"><viva:Economic_regionHasMember/></a>
            </c:when>
            <c:otherwise>
                  <a href="../<viva:Economic_regionHasMemberType/>/<viva:Economic_regionHasMemberType/>.jsp?uri=<viva:Economic_regionHasMember/>"><viva:Economic_regionHasMember /></a>
            </c:otherwise>
            </c:choose>
         </td></tr>
      </viva:foreachEconomic_regionHasMemberIterator>
